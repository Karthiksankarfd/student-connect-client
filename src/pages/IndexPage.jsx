...
const IndexPage = () => {
  ...
  const { loggedInuser, loading, isLoggedIn } = useContext(
          ...
          <div className="grid grid-cols-12  gap-7 lg:mt-5  md:mx-[calc(100%-90%)]">
            ...
            <aside className="col-span-full hidden md:block lg:col-span-3 h-dvh overflow-y-scroll">
              {isLoggedIn ? (
                ...
                <div className="w-auto h-52 bg-white text-black dark:bg-black dark:text-white p-4 rounded-lg shadow-md text-center flex flex-col justify-center items-center gap-3">
                  <img
