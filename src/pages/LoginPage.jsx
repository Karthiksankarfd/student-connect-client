    ...
    <>
      <section className="login-form-container   w-full min-h-screen grid place-items-center bg-white">
        <form className="p-6 rounded-lg  max-w-md w-full" onSubmit={login}>
          <p className="white text-center mb-5 text-[30px] text-[#0057FF]">
            Login
          </p>
          ...
          <div className="flex flex-col items-start ">
            ...
            <Link className="text-[#0057FF] text-start text-sm mb-2">
              Forget Password ?
            </Link>
          </div>
          ...
          <button
            type="submit"
            className="w-full bg-[#0057FF] text-white py-2 px-4 rounded-md transition"
          >
            Login
          </button>
