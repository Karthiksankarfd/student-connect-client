...
<section className='border-2  rounded-lg lg:w-1/2 p-5 shadow-lg   bg-[#FAF9F9] grid  '>
          ...
          <div className="profile_and_cover relative">
                <div className="cover_image">

                </div>

                <img src="https://www.pngall.com/wp-content/uploads/5/Profile-PNG-Images.png" alt="" className="profile_image rounded-full h-20 w-20 object-cover" />
          </div>
          ...
          <form className='personal_data grid w-full '>
                <div className='grid lg:grid-cols-12 grid-cols-1 grid-flow-row gap-y-3 gap-x-3'>
                        ...
                        <button className='col-span-12 bg-blue-600 text-white py-2 justify-center rounded-lg' onClick={createUser}>signup</button>
