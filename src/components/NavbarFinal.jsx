    ...
    <nav className="nav-bar-final   flex justify-between text-sm w-full  place-items-center p-2  dark:bg-black dark:text-white bg-white text-black transition-all shadow-gradient-to-b from-purple-500 shadow-gray-300 shadow-sm sticky  top-0 z-[10]">
      ...
      {isNavbarActive && (
        <div>
          ...
          ></div>
          <div className="overlay dark:bg-black dark:text-white bg-white flex flex-col text-black w-2/3 inset-0 h-dvh absolute z-[8] p-5 rounded-xl">
            <div>
              <button
            ...
            <NavLink to="mentorship" className={`group relative w-fit py-2  `} onClick={() => setisNavbarActive(!isNavbarActive)} >
              Mentorship
              <ul
                className={`list-none ${
                  isDarkMode ? "bg-slate-950 text-white" : "bg-white text-black"
                }  absolute z-50 left-0 mt-2  shadow-lg opacity-0 invisible transition-all duration-300 delay-100 group-hover:opacity-100 group-hover:visible`}
              >
            ...
            <NavLink to="opportunities" className="group relative w-fit py-2" onClick={() => setisNavbarActive(!isNavbarActive)}>
              Opportunities
      ...
      <div className="hidden lg:flex gap-x-5  navbar-links w-fit ">
        ...
        <NavLink to="events" className="group relative w-fit">
          ...
          <ul
            className={` ${
              isDarkMode ? "bg-slate-950 text-white" : "bg-white text-black"
            } list-none absolute z-50 left-0 mt-2   shadow-lg opacity-0 invisible transition-all duration-300 delay-100 group-hover:opacity-100 group-hover:visible`}
          >
            <li className="px-4 py-2 hover:bg-gray-100 whitespace-nowrap">
              Explore Events
            </li>
